...
${OBJECTDIR}/Echange.o: Echange.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Echange.o Echange.cpp
...
${OBJECTDIR}/Marche.o: Marche.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Marche.o Marche.cpp
...
${OBJECTDIR}/TestServo.o: TestServo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestServo.o TestServo.cpp
...
${OBJECTDIR}/exception/Exception.o: exception/Exception.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/exception/Exception.o exception/Exception.cpp

${OBJECTDIR}/exception/ServeurException.o: exception/ServeurException.cpp
	${MKDIR} -p ${OBJECTDIR}/exception
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/exception/ServeurException.o exception/ServeurException.cpp
